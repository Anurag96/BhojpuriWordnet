        ...
        <li><a href="contactus.jsp"><span>CONTACT US</span></a></li>
			...
			<div class="row">
				<div class="col-sm-8 col-sm-push-4">
                    ...
                    <div class="wrapper">
  <form class="login" role="form" action="registration.jsp" method="post">
      <p class="title"><b>SIGN UP</b></p>
      
    <input type="textbox" name="fname" placeholder="Enter first name" autofocus/>
    <i class="fa fa-user"></i><br><br>
    <input type="textbox"  name="lname" placeholder="Enter last name" autofocus/>
    <i class="fa fa-key"></i><br><br>
    <input type="textbox" name="uname"  placeholder="Enter username" autofocus/>
    <i class="fa fa-user"></i><br><br>
    <input type="email"  name="email" placeholder="example@gmail.com" autofocus/>
    <i class="fa fa-key"></i><br><br>
