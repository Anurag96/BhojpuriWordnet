			...
			<div class="row">
					...
					<div class="well">
						<form>
							<div class="form-group">
								<label for="contactComment">Word</label>
								<textarea class="form-control" id="contactComment"></textarea>
							</div>
                                                    <div class="form-group">
								<label for="contactComment">Concept</label>
								<textarea class="form-control" id="contactComment"></textarea>
							</div>
                                                    <div class="form-group">
								<label for="contactComment">Example</label>
								<textarea class="form-control" id="contactComment"></textarea>
							</div>
							
                                                    <div class="form-group">
								<label for="contactComment">Synonym</label>
								<textarea class="form-control" id="contactComment"></textarea>
							</div>
				...
				<div class="col-sm-4 col-sm-pull-8">
					...
					<div class="list-group margin-b-3">
					    ...
					    <a href="allwords.jsp" class="list-group-item">Word Collection</a>
